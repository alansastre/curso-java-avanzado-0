...
public class ReportService {
    ...
    // Alternativa a @Async, usar explícitamente el Executor:
//     @Qualifier("prueba")
//    private Executor prueba;

    /*

    Al crear esta tarea de forma asíncrona se ejecuta en un hilo independiente gestionado por el
    Executor Bean que se ha creado en la AsyncConfig, no bloquearía el hilo de la request,
    así evitamos que el controlador se quede bloqueado, y devuelve respuesta inmediatamente

    Combinar múltiples tareas asíncronas
     */
//    @Async("taskExecutor1")
//    @Async("taskExecutor2")
    @Async
